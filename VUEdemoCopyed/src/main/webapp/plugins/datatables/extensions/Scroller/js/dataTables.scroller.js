...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual cn.itcast.domain
	...
	/**
	 * Convert from one cn.itcast.domain to another. The physical cn.itcast.domain is the actual
	 ...
	 * only to that maximum value and virtual / physical cn.itcast.domain transforms will
